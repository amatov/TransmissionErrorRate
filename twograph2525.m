...
figure(4);
hold on;
plot(linspace(0,0.000001,N),mymatrix3(:,1));% entrance
[a,b,c,d]=textread('D:\MATLABa\50bignewY25_25_2.txt','%f %f %f %f');
plot(a,b,'r');
xlabel('Time [Seconds]');
ylabel('Voltage [Volt]');
title('Step-Response at Input');
legend('simulation', 'mesurement');
hold off;
figure(5);
...
figure(6);
hold on;
plot(linspace(0,0.000001,N),mymatrix3(:,(round(N*(l0+l2)/maxlenght)-3)));%end cable 2
plot(a,c,'r');
xlabel('Time [Seconds]');
ylabel('Voltage [Volt]');
title('Step-Response at Output 2');
legend('simulation', 'mesurement');
hold off;
figure(7);
hold on;
plot(linspace(0,0.000001,N),mymatrix3(:,N-7));%end cable 1
plot(a,d,'r');
xlabel('Time [Seconds]');
ylabel('Voltage [Volt]');
title('Step-Response at Ouput 1 ');
legend('simulation', 'mesurement');
hold off;